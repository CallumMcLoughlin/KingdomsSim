...
namespace KingdomsSim
{
    ...
    public class Input
    {
        ...
        public Rectangle MouseRectangle { get { return new Rectangle((int)Cursor.X, (int)Cursor.Y, 1, 1); } } //Used to see if mouse is over object using .Intersects()
        ...
        {
            return KeyboardState.GetPressedKeys().Length < PreviousKeyboardState.GetPressedKeys().Length;
        }
